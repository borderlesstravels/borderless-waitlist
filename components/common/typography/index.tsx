...
const classes: Record<TypographyVariant, string> = {
  ...
  "heading-2": "text-[32px]",
  "heading-3": "text-[30px]",
  "heading-4": "text-[24px] md:text-[28px]",
  "heading-5": "text-[22px]",
