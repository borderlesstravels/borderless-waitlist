...
type ToastControllerProps = Omit<
  ToastElementProps,
  "isRunning" | "onMouseEnter" | "onMouseLeave"
>;
...
const ToastController: FC<ToastControllerProps> = (props) => {
  ...
  return (
    <ToastElement
      isRunning={isRunning}
      onMouseEnter={autoDismiss ? onMouseEnter : () => undefined}
      onMouseLeave={autoDismiss ? onMouseLeave : () => undefined}
      {...props}
    />
  );
};
